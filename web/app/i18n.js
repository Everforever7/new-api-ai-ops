...
const dictionaries = {
  'zh-CN': {
    ...
    tokenInspection: {
      ...
      hint: '名称顺序、空格、大小写和分隔符不限。待复核项进入审批队列；封禁项须经第二轮 AI 独立确认。',
    ...
    settings: {
      ...
      tokenInspection: {
        ...
        allowedClientsHint: '逗号分隔。AI 会识别酒馆、ST、SillyTavern、TauriTavern、tt酒馆等别名；名称顺序和分隔符不限。',
  ...
  'en-US': {
    ...
    tokenInspection: {
      ...
      hint: 'Order, spacing, case, and separators are flexible. Review items enter the approval queue; block items require an independent second AI decision.',
    ...
    settings: {
      ...
      tokenInspection: {
        ...
        allowedClientsHint: 'Comma separated. AI recognizes aliases such as 酒馆, ST, SillyTavern, TauriTavern, and tt酒馆; order and separators are flexible.',
