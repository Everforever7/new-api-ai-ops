  ...
  'zh-CN': {
    ...
    settings: {
      ...
      prompt: {
        ...
        assistantContext: {
          title: '聊天助手实时上下文',
          hint: '开启后，每次聊天会读取当前渠道和近期调用情况，让助手了解现状。',
          maxChannels: '最大渠道数',
          ...
          hints: {
            ...
            latency: '把渠道响应时间和日志耗时纳入助手上下文',
            balance: '把渠道余额和用量纳入助手上下文；余额可能不准确',
          },
        },
      },
      safety: {
  ...
  'en-US': {
    ...
    settings: {
      ...
      prompt: {
        ...
        assistantContext: {
          title: 'Assistant live context',
          hint: 'When enabled, each chat turn loads current channels and recent usage so the assistant can see the present state.',
          ...
          hints: {
            ...
            latency: 'Includes channel response time and log latency in assistant context',
